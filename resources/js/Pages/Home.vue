                ...
                >
                    <div class="lg:pr-4">
                        ...
                        >
                            ...
                            />
                            <div
                                class="absolute inset-0 bg-gray-900 mix-blend-multiply"
                            />
                            <div
                            ...
                            <figure class="relative isolate">
                                ...
                                >
                                    <p>
                                        "Programar não é apenas escrever código. É pensar criticamente, resolver problemas e construir soluções que podem mudar o mundo." 
                                    </p>
                                </blockquote>
                                <figcaption
                    ...
                    <div>
                        ...
                        >
                            ...
                            >
                            Engenharia de Software e a Importância da Robótica com Arduino
                            </h1>
                            <div class="max-w-xl">
                                <p class="mt-6">
                                    Faculdade de Engenharia de Software tem
                                    experimentado um crescimento significativo
                                    nos últimos anos. A demanda por
                                    profissionais qualificados nesta área
                                    aumentou à medida que a tecnologia se tornou
                                    essencial em diversos setores. Estudantes
                                    aprendem a desenvolver, testar e manter
                                    sistemas de software complexos, adquirindo
                                    habilidades técnicas e práticas.
                                </p>
                                <p class="mt-8">
                                    Robótica com Arduino é um campo empolgante
                                    que integra engenharia de software e
                                    hardware. Utilizando plataformas como
                                    Tinkercad, os alunos podem simular circuitos
                                    e programar microcontroladores antes de
                                    construí-los fisicamente. Esta abordagem
                                    prática fortalece a compreensão dos
                                    princípios de eletrônica e programação,
                                    preparando os estudantes para desafios
                                    tecnológicos.
                                </p>
                            </div>
                        </div>
